    ...
    >
        <div class="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-3">
            ...
            <div class="flex items-center gap-3">
                <Button variant="outline" size="sm" @click="emit('unset-publish-date')">Unset Publish Date</Button>
                <Button variant="outline" size="sm" @click="emit('update-status')">Update Status</Button>
                <Button variant="destructive" size="sm" @click="emit('delete')">Delete Selected</Button>
