                    ...
                    >
                        <template v-for="error in errors.data" :key="error.id">
                            ...
                            >
                                ...
                                <td
                                    class="max-w-md truncate px-6 py-4 text-sm text-gray-900 dark:text-white"
                                ...
                                >
                                    <div class="space-y-2 text-sm">
                                        ...
                                        <div v-if="error.metadata">
                                            ...
                                            >
                                            <pre
                                                class="mt-1 overflow-x-auto rounded bg-gray-100 p-2 text-xs dark:bg-gray-900"
                                                >{{
                                                    formatMetadata(
                                                        error.metadata,
                                                    )
