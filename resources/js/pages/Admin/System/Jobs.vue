    ...
    <AdminLayout :breadcrumbs="breadcrumbs">
        <div class="p-6">
            ...
            <div class="mb-8">
                ...
                <!-- Pending Pagination -->
                <div
                    v-if="pendingJobs.links.length > 3"
                    class="mt-4 flex justify-center gap-1"
                >
                    <template
                        v-for="link in pendingJobs.links"
                        :key="link.label"
                    >
                        <Link
                            v-if="link.url"
            ...
            <div>
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="text-lg font-semibold">
                        Failed Jobs ({{ failedJobs.data.length }})
                    </h2>
                    <Button
                        v-if="failedJobs.data.length > 0"
                        variant="destructive"
                        size="sm"
                        @click="flushAllFailed"
                    >
                ...
                <!-- Failed Pagination -->
                <div
                    v-if="failedJobs.links.length > 3"
                    class="mt-4 flex justify-center gap-1"
                >
                    <template
                        v-for="link in failedJobs.links"
                        :key="link.label"
                    >
                        <Link
                            v-if="link.url"
