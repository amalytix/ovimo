...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                >
                    ...
                    <div class="mt-4">
                        ...
                        >
                            {{ formatNumber(stats.sources.total) }}
                        </p>
                        <p
                            class="mt-1 text-sm text-gray-600 dark:text-gray-400"
                        >
                            <span class="text-green-600 dark:text-green-400"
                                >{{ stats.sources.active }} active</span
                            >
                            <span
                                v-if="
                                    stats.sources.total - stats.sources.active >
                                    0
                                "
                ...
                >
                    ...
                    <div class="mt-4">
                        <p
                            class="text-3xl font-bold text-gray-900 dark:text-white"
                        >
                            {{ formatNumber(stats.posts.this_week) }}
                        </p>
                        <p
                            class="mt-1 text-sm text-gray-600 dark:text-gray-400"
                        >
                            <span
                                class="inline-flex items-center gap-2 rounded-full bg-purple-100 px-2 py-1 text-xs font-medium text-purple-800 dark:bg-purple-900/50 dark:text-purple-200"
                            >
                        ...
                        <div>
                            <div class="flex justify-between text-sm">
                                ...
                                <span
                                    ...
                                    >{{
                                        formatNumber(stats.tokens.today)
                                    }}</span
                                >
                            </div>
                        </div>
                        <div>
                            <div class="flex justify-between text-sm">
                                ...
                                <span
                                    class="font-medium text-gray-900 dark:text-white"
                                    >{{
                                        formatNumber(stats.tokens.last_7_days)
                                    }}</span
                                >
                            </div>
                        </div>
                        <div>
                            <div class="flex justify-between text-sm">
                                ...
                                <span
                                    class="font-medium text-gray-900 dark:text-white"
                                    >{{
                                        formatNumber(stats.tokens.last_30_days)
                                    }}</span
                                >
                            </div>
                        </div>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <div
                    class="rounded-xl border border-gray-200 bg-white p-6 md:col-span-2 lg:col-span-1 dark:border-gray-700 dark:bg-gray-900"
                >
